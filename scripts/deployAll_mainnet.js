...
async function deploy_all() {
  ...
  //   const usdc_e = "0x7F5c764cBc14f9669B88837ca1490cCa17c31607";
  ...
  //   const usdc_e = "0x37eaa0ef3549a5bb7d431be78a3d99bd360d19e5";
  ...
  //   const usdc_e = "0x176211869ca2b568f2a7d4ee941e073a821ee1ff";
  ...
  //   if (usdc_e.length > 5) {
  //     console.log("设置NFT合约的支付USDC.e合约");
  //     const r3 = await nft.updatePaymentToken(usdc_e, true);
  //     console.log(r3.hash);
  //     await mySleep(5000);
  //   }
